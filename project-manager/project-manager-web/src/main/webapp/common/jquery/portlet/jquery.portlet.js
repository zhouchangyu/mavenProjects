...
function loadData(id) {
	...
	$('.portlet_class').html("<form id = 'form1' class='dynamic-form' method='post'><table class='dynamic-form-table' style='width:90%'></table></form>");
	var $form = $('#form1');
	...
	$.ajax({
		...
		complete:function(){
			ZTreeTool.comboCtrl($("#portletList"),{url:url1});
		}
