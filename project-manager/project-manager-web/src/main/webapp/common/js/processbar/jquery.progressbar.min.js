...
(function($){$.extend({progressBar:new function(){this.defaults={steps:20,step_duration:20,max:100,showText:true,textFormat:'percentage',width:120,height:12,callback:null,boxImage:contextPath+'/common/js/processbar/images/progressbar.gif',barImage:{0:contextPath+'/common/js/processbar/images/progressbg_red.gif',30:contextPath+'/common/js/processbar/images/progressbg_orange.gif',70:contextPath+'/common/js/processbar/images/progressbg_green.gif'},running_value:0,value:0,image:null};this.construct=function(arg1,arg2){var argvalue=null;var argconfig=null;if(arg1!=null){if(!isNaN(arg1)){argvalue=arg1;if(arg2!=null){argconfig=arg2;}}else{argconfig=arg1;}}
