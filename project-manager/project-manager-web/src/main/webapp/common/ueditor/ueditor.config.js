    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'pagebreak', 'template',  '|',
...
//        ,maxListLevel : 3 //限制可以tab的级数-1不限制
        ...
        ,'fontfamily':[
			{ label:'',name:'方正仿宋_GBK',val:'方正仿宋_GBK,方正仿宋_GBK'},
			{ label:'',name:'方正小标宋_GBK',val:'方正小标宋_GBK,方正小标宋_GBK'},
			{ label:'',name:'方正楷体_GBK',val:'方正楷体_GBK,方正楷体_GBK'},
			{ label:'',name:'方正兰亭粗黑_GBK',val:'方正兰亭粗黑_GBK,方正兰亭粗黑_GBK'},
			{ label:'',name:'方正隶书_GBK',val:'方正隶书_GBK,方正隶书_GBK'},
			{ label:'',name:'方正美黑_GBK',val:'方正美黑_GBK,方正美黑_GBK'},
			{ label:'',name:'方正书宋_GBK',val:'方正书宋_GBK,方正书宋_GBK'},
			{ label:'',name:'方正魏碑_GBK',val:'方正魏碑_GBK,方正魏碑_GBK'},
			{ label:'',name:'华文细黑',val:'华文细黑,华文细黑'},
