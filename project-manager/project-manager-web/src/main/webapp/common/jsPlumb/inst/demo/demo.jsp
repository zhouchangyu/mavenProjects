...
<html>
	...
	<body >
        ...
        <div id="">
			<div id="render"></div>
			<div style="left:0em; top:50px;" class=" window" id="window1">第1步骤</div>
			<div style="left:20em; top:60px;" class="window" id="window2">第2步骤</div>
			<div style="left:40em; top:50px;" class="window" id="window3">第3步骤</div>
			<div style="left:60em; top:60px;" class="window" id="window4">第4步骤</div>
