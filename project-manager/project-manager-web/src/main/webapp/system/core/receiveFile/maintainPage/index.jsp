...
function query(){///teeDocType/getAllList.action
	...
	var url = contextPath+"/formData/getAllList.action";
...
function addReveiveNum(id){
	var url = "/system/core/receiveFile/maintainPage/addReceiveNum.jsp?id="+id;
...
function delReveiveNum(){
	if(confirm("确认删除！")){
		...
		var url = contextPath+"/formData/delDataById.action";
