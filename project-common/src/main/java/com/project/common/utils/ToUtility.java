...
public class ToUtility {
	...
	private static SimpleDateFormat dateFormatYMD = new SimpleDateFormat(
			"yyyy-MM-dd");
	private static SimpleDateFormat dateFormatYMD2 = new SimpleDateFormat(
			"yyyy/MM/dd");
	...
	private static SimpleDateFormat dateFormatEn = new SimpleDateFormat(
			"dd-MMM-yyyy", Locale.ENGLISH);
	private static SimpleDateFormat dateFormatCn = new SimpleDateFormat(
			"yyyy年MM月dd日", Locale.CHINESE);
	private static SimpleDateFormat dateFormatYMEn = new SimpleDateFormat(
			"MMM-yyyy", Locale.ENGLISH);
	private static SimpleDateFormat dateFormatYMCn = new SimpleDateFormat(
			"yyyy年MM月", Locale.CHINESE);
	private static SimpleDateFormat dateFormatMDEn = new SimpleDateFormat(
			"dd-MMM", Locale.ENGLISH);
	private static SimpleDateFormat dateFormatMDCn = new SimpleDateFormat(
			"MM-dd", Locale.CHINESE);
	 ...
	 * @return
	 */
	public static String getDateYMDStr2(Date date) {
		if (date == null) {
			return getCurDateTimeStr();
		}
		return dateFormatYMD2.format(date);
	}
	...
	public static java.sql.Timestamp parseTimeStamp(String dateStr)
		...
		if (dateStr == null) {
			...
			utilDate = ToUtility.parseDate(dateStr);
		}
		java.sql.Timestamp sqlDate = new java.sql.Timestamp(utilDate.getTime());
		return sqlDate;
	}
	...
	public static String parseDoubleStr(BigDecimal bg, int format) {
		return ToUtility.getFormatedStr(bg.doubleValue(), format);
	}
	...
	public static String getRandomName() {
		String currTimeStr = ToUtility
				.getCurDateTimeStr(ToUtility.DATE_FORMAT_NOSPLIT);
